...
const SingleProduct = ({
    ...
    const ProductDesc = (product) => {
     localStorage.setItem('cartDsc',JSON.stringify(product))
    };
    return (
        <>
            <div className="product-cart-wrap mb-30">
                <div className="product-img-action-wrap" onClick={(e)=>{ProductDesc(product)}}>
                ...
                <div className="product-content-wrap">
                    ...
                    <div className="product-card-bottom">
                        <div className="product-price">
                            <span className="old-price d-block ml-0">{product.oldPrice && `฿ ${product.oldPrice}`}</span>
                            <span className="d-block fs-6">฿{product.price} </span>
                        </div>
